<%@ Page Title="" Language="VB" MasterPageFile="~/menu.master" AutoEventWireup="false" CodeFile="ReportesCDEaCME.aspx.vb" Inherits="ReportesCDEaCME" %>
      ...
      <asp:Label ID="Distrito" runat="server" CssClass="subtitulo" ></asp:Label>
       <div><hr /></div> 
        ...
        <div class="datosrep">
            ...
            <div class="boton"><asp:Button ID="btnR1" runat="server" Text="Reporte CDE Fóraneos - CME" Height="45px" Width="291px"  /> </div>
            <div class="boton"><asp:Button ID="btnR2" runat="server" Text="Grafica CDE Fóraneos - CME" Height="45px" Width="291px"  /> </div>
            <div class="boton"><asp:Button ID="btnR3" runat="server" Text="Reporte CME Fóraneos - MDC" Height="45px" Width="291px"  /> </div>
            <div class="boton"><asp:Button ID="btnR4" runat="server" Text="Grafica CME Fóraneos - MDC" Height="45px" Width="291px"  /> </div>
        </div>
