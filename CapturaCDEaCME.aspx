<%@ Page Title="" Language="VB" MasterPageFile="~/menu.master" AutoEventWireup="false" CodeFile="CapturaCDEaCME.aspx.vb" Inherits="CapturaCDEaCME" %>
    ...
    <div class="captura">
      ...
      <asp:Label ID="titulo" runat="server" CssClass="subtitulo"></asp:Label>
       <div><hr /></div>           
        ...
        <div class="datos">
                <div><asp:label id="Label16" runat="server" CssClass="Etiqueta">Municipio:</asp:label><asp:DropDownList ID="mpios" runat="server" CssClass="Etiquetatexto" AutoPostBack="true"></asp:DropDownList></div>
                <br />  
                <br />  
