...
Partial Class CapturaDOEaCDE
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            If Session("aceptado") = "SI" Then
                titulo.Text = "IEE - Consejos Distritales Electorales Fóraneos"
    ...
    Private Sub Carga_dttos()
        ...
        Dim i As Integer
        Dim MySQL As String = "SELECT * FROM distritos WHERE id_dtto IN(1,2,3,4,5,6,7,8,12,13,14,15,18,21,22,23,24,25,26)"
