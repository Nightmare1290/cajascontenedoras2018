...
Partial Class CapturaDOEaCMEPuebla
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            If Session("aceptado") = "SI" Then
                titulo.Text = "IEE - Consejo Municipal de Puebla"
    ...
    Private Sub Carga_dttos()
        ...
        Dim i As Integer
        Dim MySQL As String = "SELECT * FROM distritos WHERE id_dtto IN(27)"
    ...
    Private Sub guarda_captura(ByRef id As Integer)
        If valida_campos() Then
            ...
            If con.ejecutar(MySQL) Then
                ...
                guardar.Enabled = False
                cancelar.Enabled = False
                Controles_Activados(False)              'Es el Privete Sub Controles_Activado
