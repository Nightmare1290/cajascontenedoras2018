<%@ Page Title="" Language="VB" MasterPageFile="~/menu.master" AutoEventWireup="false" CodeFile="CapturaCMEaMDC.aspx.vb" Inherits="CapturaCMEaMDC" %>
...
<ContentTemplate>
     ...
     <div class="captura">
       ...
       <asp:Label ID="casos" runat="server" CssClass="subtitulo"></asp:Label>
       <div><hr /></div>           

        <div class="datos">
                <div><asp:label id="Label16" runat="server" CssClass="Etiqueta">Municipio:</asp:label><asp:DropDownList ID="Mpio" runat="server" CssClass="Etiquetatexto" AutoPostBack="true"></asp:DropDownList></div>
                <div><asp:label id="Label6" runat="server" CssClass="Etiqueta">Sección:</asp:label><asp:DropDownList ID="Secc" runat="server" CssClass="Etiquetatexto" AutoPostBack="true"></asp:DropDownList></div>
                <div><asp:label id="Label7" runat="server" CssClass="Etiqueta">Casilla:</asp:label><asp:DropDownList ID="Cas" runat="server" CssClass="Etiquetatexto" AutoPostBack="true"></asp:DropDownList></div>
                <br />
                <br />      
                ...
                <div>
                <br />
                    <div><asp:Label ID="Label8" runat="server" CssClass="Etiqueta" >HORA DE ENTREGA:</asp:Label>
                        <div class="horas">
                ...
                <div><asp:Label ID="Label4" runat="server" CssClass="subtitulo">ENTREGÓ</asp:Label>
                <div><asp:label id="Label18" runat="server" CssClass="Etiqueta">NOMBRE:</asp:label><asp:textbox id="NombreE" runat="server" CssClass="Etiquetatexto" ></asp:textbox></div>
