...
Partial Class CapturaDOEaCME
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            If Session("aceptado") = "SI" Then
                titulo.Text = "IEE - Boletas Consejos Municipales Electorales"
    ...
    Private Sub Carga_Mpios()
        ...
        Dim MySQL As String = "SELECT * FROM municipios WHERE mpio < 218"
    ...
    Private Sub busca(ByRef id As String)
        Dim DS2 As Data.DataTable
        Dim i As Integer
        Dim MySQL As String = "SELECT*FROM DOE_CMEboletas WHERE mpio=" & id
        DS2 = con.consulta(MySQL)
        Dim uf As Integer = DS2.Rows.Count
        limpia()
    ...
    Private Sub guarda_captura(ByRef id As Integer)
        If valida_campos() Then
            ...
            Dim MySQL As String = "UPDATE DOE_CMEboletas SET " & _
