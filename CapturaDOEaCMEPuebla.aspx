<%@ Page Title="" Language="VB" MasterPageFile="~/menu.master" AutoEventWireup="false" CodeFile="CapturaDOEaCMEPuebla.aspx.vb" Inherits="CapturaDOEaCMEPuebla" %>
...
<ContentTemplate>
    ...
    <div class="captura">
      ...
      <div><asp:Label ID="Label1" runat="server" CssClass="subtitulo" >Entrega de Boletas Electorales</asp:Label></div>
      <asp:Label ID="titulo" runat="server" CssClass="subtitulo">DIRECCIÓN DE ORGANIZACIÓN ELECTORAL</asp:Label>
       <div><hr /></div> 
          
        <div class="datos">
                <div><asp:label id="Label16" runat="server" CssClass="Etiqueta">Municipio de Puebla:</asp:label><asp:DropDownList ID="dtto" runat="server" CssClass="Etiquetatexto" AutoPostBack="true"></asp:DropDownList></div>
                <br />   
                <br />    
                ...
                <div>
                <br />
                <div><asp:Label ID="Label6" runat="server" CssClass="Etiqueta" >HORA DE ENTREGA:</asp:Label>
                     <div class="horas">
                ...
                <div><asp:Label ID="Label4" runat="server" CssClass="subtitulo">ENTREGÓ</asp:Label></div>
