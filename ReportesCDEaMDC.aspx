<%@ Page Title="" Language="VB" MasterPageFile="~/menu.master" AutoEventWireup="false" CodeFile="ReportesCDEaMDC.aspx.vb" Inherits="ReportesCDEaMDC" %>
      ...
      <asp:Label ID="Distrito" runat="server" CssClass="subtitulo" ></asp:Label>
       <div><hr /></div> 
        ...
        <div class="datosrep">
            ...
            <div><hr /></div>
             <asp:Button ID="btnR1" runat="server" Text="Reporte CDE Puebla - MDC" Height="45px" Width="291px"  />   
              <div><hr /></div> 
             <asp:Button ID="btnR2" runat="server" Text="Grafica CDE Puebla- MDC" Height="45px" Width="291px"  />
        </div>
