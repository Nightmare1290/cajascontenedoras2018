<%@ Page Title="" Language="VB" MasterPageFile="~/menu.master" AutoEventWireup="false" CodeFile="Reportpuebla.aspx.vb" Inherits="Reportpuebla" %>
      ...
      <asp:Label ID="Distrito" runat="server" CssClass="subtitulo" ></asp:Label>
       <div><hr /></div> 
        ...
        <div class="datosrep">
            ...
            <div><hr /></div> 
                 <asp:Button ID="btnR1" runat="server" Text="Reporte CME - PUEBLA - CD'S" Height="45px" Width="291px"  /> 
              <div><hr /></div> 
                 <asp:Button ID="btnR2" runat="server" Text="Grafica CME - PUEBLA - CD'S" Height="45px" Width="291px"  />
        </div>
